<template>
  <div>
    ...
    <trashed-message v-if="user.deleted_at" class="mb-6" @restore="restore" @trash="trash">
    ...
    <div class="bg-white rounded-md shadow overflow-hidden max-w-3xl">
      <form @submit.prevent="update">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          ...
          <select-input v-if="auth.user.roles[0] === 'admin'" 
          ...
          <select-input v-if="auth.user.roles[0] === 'admin'" v-model="form.owner" :error="form.errors.owner" class="pr-6 pb-8 w-full lg:w-1/2" label="Owner">
...
export default {
  ...
  methods: {
    ...
    trash(){
       if (confirm('Are you sure you want to trash this user?')) {
        this.$inertia.put(`/users/${this.user.id}/trash`)
      }
    },
  },
}
