      ...
      <div class="md:h-screen md:flex md:flex-col">
        <div class="md:flex md:flex-shrink-0">
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
            ...
            <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500 w-full text-left" :href="`/users/${auth.user.id}/edit`">My Profile</Link>
            <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white w-full text-left" v-if="auth.user.roles[0]==='admin'" href="/users">Manage Users</Link>
            <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white w-full text-left" v-if="auth.user.roles[0]==='admin'" href="/permissions">Manage Permissions</Link>
            <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white w-full text-left" v-if="auth.user.roles[0]==='admin'" href="/roles">Manage Roles</Link>
