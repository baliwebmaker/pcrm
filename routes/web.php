...
//UserRegistrations
Route::get('registrations', [UsersController::class, 'register'])
    ->name('registrations')->middleware('guest');

Route::post('registrations', [UsersController::class, 'storeregistration'])
    ->name('registrations.storeregistration')
    ->middleware('guest');
...
Route::group([
    ...
    //permissions
        ...
        Route::put('permissions/{permission}/trash', [PermissionsController::class, 'trash'])
    ...
    //roles
        ...
        Route::post('roles/{assignedPermissions}', [RolesController::class, 'store'])
        ->name('roles.store')
        ->middleware('auth');
        ...
        Route::put('roles/{role}/{assignedPermissions}', [RolesController::class, 'update'])
        ->name('roles.update')
        ->middleware('auth');
