...
class RolesController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, $assignedPermissions)
    {
        //validate input
        $request->validate(
            [
        ...
        $permissions = json_decode($assignedPermissions, true);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $role, $assignedPermissions )
    {
        //validate input
        $request->validate(
            [
